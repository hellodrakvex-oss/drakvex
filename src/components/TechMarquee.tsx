        ...
        >
          ...
          {[...techs, ...techs].map((tech, i) => (
            <div key={i} className="flex items-center gap-4">
              <span className="text-xl md:text-3xl font-space-grotesk font-bold text-white/40 uppercase tracking-widest hover:text-white/80 transition-colors cursor-default">
                {tech}
              </span>
